...
namespace Webkul\Onepay\Helpers;

use Webkul\Sales\Repositories\OrderRepository;
use Webkul\Sales\Repositories\InvoiceRepository;

/**
 * Onepay ipn listener helper
 *
...
class Ipn
{
    ...
    /**
     * This function process the ipn sent from Onepay end
     *
     * @param array $post
     * @return void
     */
    ...
    /**
     * Post back to Onepay to check whether this request is a valid one
     *
    ...
    protected function postBack()
    {
        if (array_key_exists('test_ipn', $this->post) && 1 === (int) $this->post['test_ipn'])
            $url = 'https://www.sandbox.Onepay.com/cgi-bin/webscr';
        else
            $url = 'https://www.Onepay.com/cgi-bin/webscr';

        // Set up request to Onepay
        $request = curl_init();
