                ...
                <div class="left-side">
                    <form action="{{ route('shop.checkout.cart.update') }}" method="POST" @submit.prevent="onSubmit">
                        ...
                        <div class="misc-controls">
                            ...
                            <div>
                                <button type="submit" class="ps-btn btn-lg btn-primary">
                                    {{ __('shop::app.checkout.cart.update-cart') }}
                                </button>

                                @if (! cart()->hasError())
                                    <a href="{{ route('shop.checkout.onepage.index') }}" class="ps-btn btn-lg btn-primary">
        ...
        @else
            ...
            <div class="cart-content">
                ...
                <p style="display: inline-block;">
                    <a style="display: inline-block;" href="{{ route('shop.home.index') }}" class="ps-btn ps-btn--gray">{{ __('shop::app.checkout.cart.continue-shopping') }}</a>
                </p>
            </div>
